...
static t_command *check_fill_size(t_command *command, char *str, t_op darling, char *str_orig)
{
	t_command *copy;
	char *arg;
	int i;
...
static int count_block_size(int fd, char *str, int end, t_command *command)
{
	int i;
	char *constuct;
	t_op darling;
